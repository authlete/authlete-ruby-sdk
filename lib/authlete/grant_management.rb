  ...
  class GrantManagement
    ...
    def process_request(g_m_request:, service_id:, timeout_ms: nil)
      ...
      url = Utils.generate_url(
        Models::Operations::GrantMApiRequest,
        base_url,
        '/api/{serviceId}/gm',
        request
      )
      ...
      req_content_type, data, form = Utils.serialize_request_body(request, false, false, :g_m_request, :json)
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::GMResponse)
          response = Models::Operations::GrantMApiResponse.new(
