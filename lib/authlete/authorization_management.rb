  ...
  class AuthorizationManagement
    ...
    def get_ticket_info(authorization_ticket_info_request:, service_id:, timeout_ms: nil)
      ...
      url = Utils.generate_url(
        Models::Operations::AuthorizationTicketInfoPostApiRequest,
        base_url,
      ...
      req_content_type, data, form = Utils.serialize_request_body(request, false, false, :authorization_ticket_info_request, :json)
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::AuthorizationTicketInfoResponse)
          response = Models::Operations::AuthorizationTicketInfoPostApiResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            authorization_ticket_info_response: T.unsafe(obj)
          )
    ...
    def update_ticket(authorization_ticket_update_request:, service_id:, timeout_ms: nil)
      ...
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        Models::Operations::UpdateAuthorizationTicketRequest,
        base_url,
      ...
      headers = {}
      headers = T.cast(headers, T::Hash[String, String])
      req_content_type, data, form = Utils.serialize_request_body(request, false, false, :authorization_ticket_update_request, :json)
      headers['content-type'] = req_content_type
      raise StandardError, 'request body is required' if data.nil? && form.nil?
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response_data = http_response.env.response_body
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::AuthorizationTicketUpdateResponse)
          response = Models::Operations::UpdateAuthorizationTicketResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            authorization_ticket_update_response: T.unsafe(obj)
          )
