  ...
  class JoseObject
    ...
    def jose_verify_api(service_id:, jose_verify_request: nil, timeout_ms: nil)
      ...
      url = Utils.generate_url(
        Models::Operations::JoseVerifyApiRequest,
        base_url,
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::JoseVerifyResponse)
          response = Models::Operations::JoseVerifyApiResponse.new(
