...
module Authlete
  ...
  class Service
    ...
    def get(service_id:, timeout_ms: nil)
      # get - Get Service
      # Get a service.
      # 
    ...
    def delete(service_id:, timeout_ms: nil)
    ...
    def get_configuration(service_id:, pretty: nil, patch: nil, timeout_ms: nil)
      # get_configuration - Get Service Configuration
