  ...
  class PushedAuthorization
    ...
    def create(pushed_authorization_request:, service_id:, timeout_ms: nil)
      ...
      url = Utils.generate_url(
        Models::Operations::PushedAuthReqApiRequest,
        base_url,
      ...
      req_content_type, data, form = Utils.serialize_request_body(request, false, false, :pushed_authorization_request, :json)
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::PushedAuthorizationResponse)
          response = Models::Operations::PushedAuthReqApiResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            pushed_authorization_response: T.unsafe(obj)
          )
