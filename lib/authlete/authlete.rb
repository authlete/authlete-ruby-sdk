...
module Authlete
  ...
  class Authlete
    ...
    attr_accessor :service, :client, :authorization, :pushed_authorization, :token, :introspection, :revocation, :userinfo, :grant_management, :jwk_set_endpoint, :dynamic_client_registration, :ciba, :device_flow, :jose_object, :federation, :hardware_security_keys, :verifiable_credentials, :native_sso
