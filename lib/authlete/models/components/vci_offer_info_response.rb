  ...
  module Models
    module Components
      ...
      class VciOfferInfoResponse
        ...
        sig { params(result_code: T.nilable(::String), result_message: T.nilable(::String), action: T.nilable(Models::Components::VciOfferInfoResponseAction), info: T.nilable(Models::Components::CredentialOfferInfo)).void }
