...
class Authlete::Models::Components::CredentialOfferInfo
...
class Authlete::Models::Components::CredentialOfferInfo
  ...
  def credential_offer(); end
  def credential_offer=(str_); end
  ...
  def issuer_state(); end
  def issuer_state=(str_); end
  def pre_authorized_code_grant_included(); end
  def pre_authorized_code_grant_included=(str_); end
  def pre_authorized_code(); end
  def pre_authorized_code=(str_); end
  def subject(); end
