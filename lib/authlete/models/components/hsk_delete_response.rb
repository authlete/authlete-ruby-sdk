  ...
  module Models
    module Components
      ...
      class HskDeleteResponse
        ...
        field :action, Crystalline::Nilable.new(Models::Components::HskDeleteResponseAction), { 'format_json': { 'letter_case': ::Authlete::Utils.field_name('action'), 'decoder': ::Authlete::Utils.enum_from_string(Models::Components::HskDeleteResponseAction, true) } }
