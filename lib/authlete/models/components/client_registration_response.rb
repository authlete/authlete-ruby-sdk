  ...
  module Models
    module Components
      ...
      class ClientRegistrationResponse
        ...
        sig { params(result_code: T.nilable(::String), result_message: T.nilable(::String), action: T.nilable(Models::Components::ClientRegistrationResponseAction), response_content: T.nilable(::String), client: T.nilable(Models::Components::Client)).void }
