  ...
  module Models
    module Components
      ...
      class FederationRegistrationResponse
        ...
        field :action, Crystalline::Nilable.new(Models::Components::FederationRegistrationResponseAction), { 'format_json': { 'letter_case': ::Authlete::Utils.field_name('action'), 'decoder': ::Authlete::Utils.enum_from_string(Models::Components::FederationRegistrationResponseAction, true) } }
        ...
        sig { params(result_code: T.nilable(::String), result_message: T.nilable(::String), action: T.nilable(Models::Components::FederationRegistrationResponseAction), response_content: T.nilable(::String), client: T.nilable(Models::Components::Client)).void }
        def initialize(result_code: nil, result_message: nil, action: nil, response_content: nil, client: nil)
