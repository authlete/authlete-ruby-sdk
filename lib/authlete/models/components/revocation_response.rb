  ...
  module Models
    module Components
      ...
      class RevocationResponse
        ...
        field :action, Crystalline::Nilable.new(Models::Components::RevocationResponseAction), { 'format_json': { 'letter_case': ::Authlete::Utils.field_name('action'), 'decoder': Utils.enum_from_string(Models::Components::RevocationResponseAction, true) } }
