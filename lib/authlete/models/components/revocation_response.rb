  ...
  module Models
    module Components
      ...
      class RevocationResponse
        ...
        field :action, Crystalline::Nilable.new(Models::Components::RevocationResponseAction), { 'format_json': { 'letter_case': ::Authlete::Utils.field_name('action'), 'decoder': ::Authlete::Utils.enum_from_string(Models::Components::RevocationResponseAction, true) } }
        ...
        sig { params(result_code: T.nilable(::String), result_message: T.nilable(::String), action: T.nilable(Models::Components::RevocationResponseAction), response_content: T.nilable(::String)).void }
