  ...
  module Models
    module Components
      ...
      class HskCreateResponse
        ...
        field :action, Crystalline::Nilable.new(Models::Components::HskCreateResponseAction), { 'format_json': { 'letter_case': ::Authlete::Utils.field_name('action'), 'decoder': ::Authlete::Utils.enum_from_string(Models::Components::HskCreateResponseAction, true) } }
        ...
        sig { params(result_code: T.nilable(::String), result_message: T.nilable(::String), action: T.nilable(Models::Components::HskCreateResponseAction), hsk: T.nilable(Models::Components::Hsk)).void }
