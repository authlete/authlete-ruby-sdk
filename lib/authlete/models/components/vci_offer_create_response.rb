  ...
  module Models
    module Components
      ...
      class VciOfferCreateResponse
        ...
        field :action, Crystalline::Nilable.new(Models::Components::VciOfferCreateResponseAction), { 'format_json': { 'letter_case': ::Authlete::Utils.field_name('action'), 'decoder': ::Authlete::Utils.enum_from_string(Models::Components::VciOfferCreateResponseAction, true) } }
