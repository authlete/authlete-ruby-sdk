  ...
  module Models
    module Components
      ...
      class FederationConfigurationResponse
        ...
        field :action, Crystalline::Nilable.new(Models::Components::FederationConfigurationResponseAction), { 'format_json': { 'letter_case': ::Authlete::Utils.field_name('action'), 'decoder': ::Authlete::Utils.enum_from_string(Models::Components::FederationConfigurationResponseAction, true) } }
        ...
        sig { params(result_code: T.nilable(::String), result_message: T.nilable(::String), action: T.nilable(Models::Components::FederationConfigurationResponseAction), response_content: T.nilable(::String)).void }
