  ...
  module Models
    module Components
      ...
      class FederationConfigurationResponse
        ...
        field :action, Crystalline::Nilable.new(Models::Components::FederationConfigurationResponseAction), { 'format_json': { 'letter_case': ::Authlete::Utils.field_name('action'), 'decoder': Utils.enum_from_string(Models::Components::FederationConfigurationResponseAction, true) } }
