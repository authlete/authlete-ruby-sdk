  ...
  module Models
    module Components
      ...
      class DeviceCompleteRequest
        ...
        #
        field :result, Models::Components::DeviceCompleteRequestResult, { 'format_json': { 'letter_case': ::Authlete::Utils.field_name('result'), required: true, 'decoder': ::Authlete::Utils.enum_from_string(Models::Components::DeviceCompleteRequestResult, false) }, 'form': { 'field_name': 'result' } }
