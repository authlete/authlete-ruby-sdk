...
class Authlete::Models::Components::BackchannelAuthenticationCompleteResponse
...
class Authlete::Models::Components::BackchannelAuthenticationCompleteResponse
  ...
  def client_notification_endpoint(); end
  def client_notification_endpoint=(str_); end
  def client_notification_token(); end
  def client_notification_token=(str_); end
  def auth_req_id(); end
  def auth_req_id=(str_); end
