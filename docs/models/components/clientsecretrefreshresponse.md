...
| `new_client_secret`                                        | *T.nilable(::String)*                                      | :heavy_minus_sign:                                         | The new client secret.<br/>                                |
| `old_client_secret`                                        | *T.nilable(::String)*                                      | :heavy_minus_sign:                                         | The old client secret.<br/>                                |